...
main = pygame.image.load("practice9/mickeys_clock/images/clock.png")
left = pygame.image.load("practice9/mickeys_clock/images/sec_hand.png")
right = pygame.image.load("practice9/mickeys_clock/images/min_hand.png")
running = True
x = time_angle()
